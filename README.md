...
```sh
docker pull hlohaus789/g4f
docker run -p 8083:8083 -p 1337:1337 -p 7900:7900 --shm-size="2g" hlohaus789/g4f:latest
```
3. Open the included client on: [http://localhost:8083/chat/](http://localhost:8083/chat/)
